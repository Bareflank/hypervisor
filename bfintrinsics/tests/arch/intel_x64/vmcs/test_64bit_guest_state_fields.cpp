...
TEST_CASE("vmcs_guest_ia32_bndcfgs")
{
    ...
    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_bndcfgs::mask <<
            32;
    CHECK(exists());

    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] &= ~(msrs::ia32_vmx_true_entry_ctls::load_ia32_bndcfgs::mask
            << 32);
    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::clear_ia32_bndcfgs::mask <<
            32;
    CHECK(exists());
