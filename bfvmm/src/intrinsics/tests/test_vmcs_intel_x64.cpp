...
//    mocks.OnCall(state_in, vmcs_intel_x64_state::cs_access_rights).Return(
//        access_rights::ring0_cs_descriptor);
//    mocks.OnCall(state_in, vmcs_intel_x64_state::ss_access_rights).Return(
//        access_rights::ring0_ss_descriptor);
//    mocks.OnCall(state_in, vmcs_intel_x64_state::ds_access_rights).Return(access_rights::unusable);
//    mocks.OnCall(state_in, vmcs_intel_x64_state::fs_access_rights).Return(
//        access_rights::ring0_fs_descriptor);
//    mocks.OnCall(state_in, vmcs_intel_x64_state::gs_access_rights).Return(
//        access_rights::ring0_gs_descriptor);
//    mocks.OnCall(state_in, vmcs_intel_x64_state::ldtr_access_rights).Return(access_rights::unusable);
//    mocks.OnCall(state_in, vmcs_intel_x64_state::tr_access_rights).Return(
//        access_rights::ring0_tr_descriptor);
//
//    auto cr0 = 0UL;
//    cr0 |= cr0::paging::mask;
...
//
//void
//intrinsics_ut::test_vmcs_vm_instruction_error_description()
//{
...
//    this->expect_true(vm_instruction_error_description(1UL,
//                      exists) == "VMCALL executed in VMX root operation"_s);
//}
//
//void
//intrinsics_ut::test_vmcs_vm_instruction_error_description_if_exists()
//{
//    using namespace vmcs::vm_instruction_error;
//
//    bool exists = true;
...
//    this->expect_true(vm_instruction_error_description_if_exists(1UL, verbose,
//                      exists) == "VMCALL executed in VMX root operation"_s);
//}
//
//void
//intrinsics_ut::test_vmcs_exit_reason_basic_exit_reason_description()
//{
//    using namespace vmcs::exit_reason;
//
//    bool exists = true;
//
//    this->expect_exception([&] { basic_exit_reason::basic_exit_reason_description(0UL, !exists); },
//                           ""_ut_lee);
//    this->expect_true(basic_exit_reason::basic_exit_reason_description(basic_exit_reason::pause,
//                      exists) == "pause"_s);
//}
//
//void
//intrinsics_ut::test_vmcs_exit_reason_basic_exit_reason_description_if_exists()
//{
//    using namespace vmcs::exit_reason;
//
//    bool exists = true;
...
//    this->expect_true(basic_exit_reason::basic_exit_reason_description_if_exists(0UL, verbose,
//                      !exists) == ""_s);
//    this->expect_true(basic_exit_reason::basic_exit_reason_description_if_exists(
//                          basic_exit_reason::pause, verbose, exists) == "pause"_s);
//}
//
//void
//intrinsics_ut::test_vmcs_virtual_processor_identifier()
//{
...
//
//void
//intrinsics_ut::test_vmcs_posted_interrupt_notification_vector()
//{
...
//
//void
//intrinsics_ut::test_vmcs_eptp_index()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] =
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
...
//
//void
//intrinsics_ut::test_vmcs_guest_es_selector()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_es_selector_rpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_es_selector_ti()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_es_selector_index()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cs_selector()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cs_selector_rpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cs_selector_ti()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cs_selector_index()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ss_selector()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ss_selector_rpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ss_selector_ti()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ss_selector_index()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ds_selector()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ds_selector_rpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ds_selector_ti()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ds_selector_index()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_fs_selector()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_fs_selector_rpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_fs_selector_ti()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_fs_selector_index()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_gs_selector()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_gs_selector_rpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_gs_selector_ti()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_gs_selector_index()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ldtr_selector()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ldtr_selector_rpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ldtr_selector_ti()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ldtr_selector_index()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_tr_selector()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_tr_selector_rpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_tr_selector_ti()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_tr_selector_index()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_interrupt_status()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] =
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] =
...
//
//void
//intrinsics_ut::test_vmcs_host_es_selector()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_es_selector_rpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_es_selector_ti()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_es_selector_index()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cs_selector()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cs_selector_rpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cs_selector_ti()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cs_selector_index()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_ss_selector()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_ss_selector_rpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_ss_selector_ti()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_ss_selector_index()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_ds_selector()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_ds_selector_rpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_ds_selector_ti()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_ds_selector_index()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_fs_selector()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_fs_selector_rpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_fs_selector_ti()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_fs_selector_index()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_gs_selector()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_gs_selector_rpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_gs_selector_ti()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_gs_selector_index()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_tr_selector()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_tr_selector_rpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_tr_selector_ti()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_tr_selector_index()
//{
...
//
//void
//intrinsics_ut::test_vmcs_address_of_io_bitmap_a()
//{
...
//
//void
//intrinsics_ut::test_vmcs_address_of_io_bitmap_b()
//{
...
//
//void
//intrinsics_ut::test_vmcs_address_of_msr_bitmap()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_msr_store_address()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_msr_load_address()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_entry_msr_load_address()
//{
...
//
//void
//intrinsics_ut::test_vmcs_executive_vmcs_pointer()
//{
...
//
//void
//intrinsics_ut::test_vmcs_pml_address()
//{
...
//
//void
//intrinsics_ut::test_vmcs_tsc_offset()
//{
...
//
//void
//intrinsics_ut::test_vmcs_virtual_apic_address()
//{
...
//
//void
//intrinsics_ut::test_vmcs_apic_access_address()
//{
//    proc_ctl_allow1(msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask);
...
//
//void
//intrinsics_ut::test_vmcs_posted_interrupt_descriptor_address()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_function_controls()
//{
//    proc_ctl_allow1(msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask);
...
//
//void
//intrinsics_ut::test_vmcs_vm_function_controls_eptp_switching()
//{
//    proc_ctl_allow1(msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask);
//    proc_ctl2_allow1(msrs::ia32_vmx_procbased_ctls2::enable_vm_functions::mask);
...
//
//void
//intrinsics_ut::test_vmcs_vm_function_controls_reserved()
//{
//    proc_ctl_allow1(msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask);
//    proc_ctl2_allow1(msrs::ia32_vmx_procbased_ctls2::enable_vm_functions::mask);
//
...
//
//void
//intrinsics_ut::test_vmcs_ept_pointer()
//{
//    proc_ctl_allow1(msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask);
...
//
//void
//intrinsics_ut::test_vmcs_ept_pointer_memory_type()
//{
//    proc_ctl_allow1(msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask);
//    proc_ctl2_allow1(msrs::ia32_vmx_procbased_ctls2::enable_ept::mask);
//
//    vmcs::ept_pointer::memory_type::set(0UL);
//    this->expect_true(vmcs::ept_pointer::memory_type::get() ==
//                      vmcs::ept_pointer::memory_type::uncacheable);
//
//    vmcs::ept_pointer::memory_type::set_if_exists(6UL);
//    this->expect_true(vmcs::ept_pointer::memory_type::get_if_exists() ==
...
//
//void
//intrinsics_ut::test_vmcs_ept_pointer_page_walk_length_minus_one()
//{
//    proc_ctl_allow1(msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask);
//    proc_ctl2_allow1(msrs::ia32_vmx_procbased_ctls2::enable_ept::mask);
//
...
//
//void
//intrinsics_ut::test_vmcs_ept_pointer_accessed_and_dirty_flags()
//{
//    proc_ctl_allow1(msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask);
//    proc_ctl2_allow1(msrs::ia32_vmx_procbased_ctls2::enable_ept::mask);
//
...
//
//void
//intrinsics_ut::test_vmcs_ept_pointer_phys_addr()
//{
//    proc_ctl_allow1(msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask);
//    proc_ctl2_allow1(msrs::ia32_vmx_procbased_ctls2::enable_ept::mask);
//
...
//
//void
//intrinsics_ut::test_vmcs_ept_pointer_reserved()
//{
//    proc_ctl_allow1(msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask);
//    proc_ctl2_allow1(msrs::ia32_vmx_procbased_ctls2::enable_ept::mask);
//
...
//
//void
//intrinsics_ut::test_vmcs_eoi_exit_bitmap_0()
//{
//    proc_ctl_allow1(msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask);
...
//
//void
//intrinsics_ut::test_vmcs_eoi_exit_bitmap_1()
//{
//    proc_ctl_allow1(msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask);
//    proc_ctl2_allow1(msrs::ia32_vmx_procbased_ctls2::virtual_interrupt_delivery::mask);
...
//
//void
//intrinsics_ut::test_vmcs_eoi_exit_bitmap_2()
//{
//    proc_ctl_allow1(msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask);
//    proc_ctl2_allow1(msrs::ia32_vmx_procbased_ctls2::virtual_interrupt_delivery::mask);
...
//
//void
//intrinsics_ut::test_vmcs_eoi_exit_bitmap_3()
//{
//    proc_ctl_allow1(msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask);
//    proc_ctl2_allow1(msrs::ia32_vmx_procbased_ctls2::virtual_interrupt_delivery::mask);
...
//
//void
//intrinsics_ut::test_vmcs_eptp_list_address()
//{
//    proc_ctl_allow1(msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask);
//    proc_ctl2_allow1(msrs::ia32_vmx_procbased_ctls2::enable_vm_functions::mask);
//    vmfunc_ctl_allow1(msrs::ia32_vmx_vmfunc::eptp_switching::mask);
...
//
//void
//intrinsics_ut::test_vmcs_vmread_bitmap_address()
//{
//    proc_ctl_allow1(msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask);
...
//
//void
//intrinsics_ut::test_vmcs_vmwrite_bitmap_address()
//{
//    proc_ctl_allow1(msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask);
//    proc_ctl2_allow1(msrs::ia32_vmx_procbased_ctls2::vmcs_shadowing::mask);
...
//
//void
//intrinsics_ut::test_vmcs_virtualization_exception_information_address()
//{
//    proc_ctl_allow1(msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask);
...
//
//    this->expect_exception([&] { vmcs::virtualization_exception_information_address::set(42U); },
//                           ""_ut_lee);
//    this->expect_exception([&] { vmcs::virtualization_exception_information_address::get(); },
//                           ""_ut_lee);
//
...
//
//void
//intrinsics_ut::test_vmcs_xss_exiting_bitmap()
//{
//    proc_ctl_allow1(msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask);
...
//
//void
//intrinsics_ut::test_vmcs_vmcs_link_pointer()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_debugctl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_debugctl_lbr()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_debugctl_btf()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_debugctl_tr()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_debugctl_bts()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_debugctl_btint()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_debugctl_bt_off_os()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_debugctl_bt_off_user()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_debugctl_freeze_lbrs_on_pmi()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_debugctl_freeze_perfmon_on_pmi()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_debugctl_enable_uncore_pmi()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_debugctl_freeze_while_smm()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_debugctl_rtm_debug()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_debugctl_reserved()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa0()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa0_memory_type()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa0_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa1()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa1_memory_type()
//{
//    using namespace vmcs::guest_ia32_pat;
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa1_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa2()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa2_memory_type()
//{
//    using namespace vmcs::guest_ia32_pat;
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa2_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa3()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa3_memory_type()
//{
//    using namespace vmcs::guest_ia32_pat;
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa3_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa4()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa4_memory_type()
//{
//    using namespace vmcs::guest_ia32_pat;
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa4_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa5()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa5_memory_type()
//{
//    using namespace vmcs::guest_ia32_pat;
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa5_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa6()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa6_memory_type()
//{
//    using namespace vmcs::guest_ia32_pat;
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa6_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa7()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa7_memory_type()
//{
//    using namespace vmcs::guest_ia32_pat;
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_pat_pa7_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_pat::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_efer()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_efer_sce()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_efer::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_efer_lme()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_efer::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_efer_lma()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_efer::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_efer_nxe()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_efer::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_efer_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= msrs::ia32_vmx_true_entry_ctls::load_ia32_efer::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_perf_global_ctrl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_perf_global_ctrl_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |=
//        msrs::ia32_vmx_true_entry_ctls::load_ia32_perf_global_ctrl::mask << 32;
//    this->expect_true(vmcs::guest_ia32_perf_global_ctrl::exists());
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte0()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte0_present()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte0_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte0_pwt()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte0_pcd()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte0_page_directory_addr()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte1()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte1_present()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte1_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte1_pwt()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte1_pcd()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte1_page_directory_addr()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte2()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte2_present()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte2_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte2_pwt()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte2_pcd()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte2_page_directory_addr()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte3()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte3_present()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte3_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte3_pwt()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte3_pcd()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_pdpte3_page_directory_addr()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] |=
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] |= msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_bndcfgs()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_bndcfgs_en()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= ia32_vmx_true_entry_ctls::load_ia32_bndcfgs::mask <<
//            32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_bndcfgs_bndpreserve()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= ia32_vmx_true_entry_ctls::load_ia32_bndcfgs::mask <<
//            32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_bndcfgs_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= ia32_vmx_true_entry_ctls::load_ia32_bndcfgs::mask <<
//            32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_bndcfgs_base_addr_of_bnd_directory()
//{
//    g_msrs[msrs::ia32_vmx_true_entry_ctls::addr] |= ia32_vmx_true_entry_ctls::load_ia32_bndcfgs::mask <<
//            32;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_physical_address()
//{
//    g_msrs[msrs::ia32_vmx_true_procbased_ctls::addr] =
//        msrs::ia32_vmx_true_procbased_ctls::activate_secondary_controls::mask << 32;
//    g_msrs[msrs::ia32_vmx_procbased_ctls2::addr] = msrs::ia32_vmx_procbased_ctls2::enable_ept::mask <<
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa0()
//{
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
//
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa0_memory_type()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa0_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
//
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa1()
//{
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
//
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa1_memory_type()
//{
//    using namespace vmcs::host_ia32_pat;
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa1_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
//
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa2()
//{
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
//
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa2_memory_type()
//{
//    using namespace vmcs::host_ia32_pat;
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa2_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
//
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa3()
//{
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
//
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa3_memory_type()
//{
//    using namespace vmcs::host_ia32_pat;
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa3_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
//
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa4()
//{
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
//
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa4_memory_type()
//{
//    using namespace vmcs::host_ia32_pat;
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa4_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
//
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa5()
//{
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
//
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa5_memory_type()
//{
//    using namespace vmcs::host_ia32_pat;
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa5_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
//
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa6()
//{
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
//
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa6_memory_type()
//{
//    using namespace vmcs::host_ia32_pat;
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa6_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
//
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa7()
//{
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
//
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa7_memory_type()
//{
//    using namespace vmcs::host_ia32_pat;
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_pat_pa7_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_pat::mask <<
//            32;
//
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_efer()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_efer_sce()
//{
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_efer::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_efer_lme()
//{
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_efer::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_efer_lma()
//{
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_efer::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_efer_nxe()
//{
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_efer::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_efer_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |= msrs::ia32_vmx_true_exit_ctls::load_ia32_efer::mask
//            << 32;
//
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_perf_global_ctrl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_perf_global_ctrl_reserved()
//{
//    g_msrs[msrs::ia32_vmx_true_exit_ctls::addr] |=
//        msrs::ia32_vmx_true_exit_ctls::load_ia32_perf_global_ctrl::mask << 32;
//    this->expect_true(vmcs::host_ia32_perf_global_ctrl::exists());
...
//
//void
//intrinsics_ut::test_vmcs_guest_rflags()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_rflags_carry_flag()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_rflags_parity_flag()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_rflags_auxiliary_carry_flag()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_rflags_zero_flag()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_rflags_sign_flag()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_rflags_trap_flag()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_rflags_interrupt_enable_flag()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_rflags_direction_flag()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_rflags_overflow_flag()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_rflags_privilege_level()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_rflags_nested_task()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_rflags_resume_flag()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_rflags_virtual_8086_mode()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_rflags_alignment_check_access_control()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_rflags_virtual_interupt_flag()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_rflags_virtual_interupt_pending()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_rflags_id_flag()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_rflags_reserved()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_rflags_always_disabled()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_rflags_always_enabled()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_pending_debug_exceptions()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_pending_debug_exceptions_b0()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_pending_debug_exceptions_b1()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_pending_debug_exceptions_b2()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_pending_debug_exceptions_b3()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_pending_debug_exceptions_reserved()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_pending_debug_exceptions_enabled_breakpoint()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_pending_debug_exceptions_bs()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_pending_debug_exceptions_rtm()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_sysenter_esp()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_sysenter_eip()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr0()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr0_protection_enable()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr0_monitor_coprocessor()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr0_emulation()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr0_task_switched()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr0_extension_type()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr0_numeric_error()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr0_write_protect()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr0_alignment_mask()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr0_not_write_through()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr0_cache_disable()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr0_paging()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr3()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr4()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr4_v8086_mode_extensions()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr4_protected_mode_virtual_interrupts()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr4_time_stamp_disable()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr4_debugging_extensions()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr4_page_size_extensions()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr4_physical_address_extensions()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr4_machine_check_enable()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr4_page_global_enable()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr4_performance_monitor_counter_enable()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr4_osfxsr()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr4_osxmmexcpt()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr4_vmx_enable_bit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr4_smx_enable_bit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr4_fsgsbase_enable_bit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr4_pcid_enable_bit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr4_osxsave()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr4_smep_enable_bit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr4_smap_enable_bit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cr4_protection_key_enable_bit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_es_base()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cs_base()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ss_base()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ds_base()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_fs_base()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_gs_base()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ldtr_base()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_tr_base()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_gdtr_base()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_idtr_base()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_dr7()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_rsp()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_rip()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr0()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr0_protection_enable()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr0_monitor_coprocessor()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr0_emulation()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr0_task_switched()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr0_extension_type()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr0_numeric_error()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr0_write_protect()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr0_alignment_mask()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr0_not_write_through()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr0_cache_disable()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr0_paging()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr3()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr4()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr4_v8086_mode_extensions()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr4_protected_mode_virtual_interrupts()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr4_time_stamp_disable()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr4_debugging_extensions()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr4_page_size_extensions()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr4_physical_address_extensions()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr4_machine_check_enable()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr4_page_global_enable()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr4_performance_monitor_counter_enable()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr4_osfxsr()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr4_osxmmexcpt()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr4_vmx_enable_bit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr4_smx_enable_bit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr4_fsgsbase_enable_bit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr4_pcid_enable_bit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr4_osxsave()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr4_smep_enable_bit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr4_smap_enable_bit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_cr4_protection_key_enable_bit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_fs_base()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_gs_base()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_tr_base()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_gdtr_base()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_idtr_base()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_sysenter_esp()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_sysenter_eip()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_rsp()
//{
...
//
//void
//intrinsics_ut::test_vmcs_host_rip()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_es_limit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cs_limit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ss_limit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ds_limit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_fs_limit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_gs_limit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ldtr_limit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_tr_limit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_gdtr_limit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_idtr_limit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_es_access_rights()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_es_access_rights_type()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_es_access_rights_s()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_es_access_rights_dpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_es_access_rights_present()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_es_access_rights_avl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_es_access_rights_l()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_es_access_rights_db()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_es_access_rights_granularity()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_es_access_rights_reserved()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_es_access_rights_unusable()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cs_access_rights()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cs_access_rights_type()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cs_access_rights_s()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cs_access_rights_dpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cs_access_rights_present()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cs_access_rights_avl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cs_access_rights_l()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cs_access_rights_db()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cs_access_rights_granularity()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cs_access_rights_reserved()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_cs_access_rights_unusable()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ss_access_rights()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ss_access_rights_type()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ss_access_rights_s()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ss_access_rights_dpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ss_access_rights_present()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ss_access_rights_avl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ss_access_rights_l()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ss_access_rights_db()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ss_access_rights_granularity()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ss_access_rights_reserved()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ss_access_rights_unusable()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ds_access_rights()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ds_access_rights_type()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ds_access_rights_s()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ds_access_rights_dpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ds_access_rights_present()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ds_access_rights_avl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ds_access_rights_l()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ds_access_rights_db()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ds_access_rights_granularity()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ds_access_rights_reserved()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ds_access_rights_unusable()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_fs_access_rights()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_fs_access_rights_type()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_fs_access_rights_s()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_fs_access_rights_dpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_fs_access_rights_present()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_fs_access_rights_avl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_fs_access_rights_l()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_fs_access_rights_db()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_fs_access_rights_granularity()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_fs_access_rights_reserved()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_fs_access_rights_unusable()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_gs_access_rights()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_gs_access_rights_type()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_gs_access_rights_s()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_gs_access_rights_dpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_gs_access_rights_present()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_gs_access_rights_avl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_gs_access_rights_l()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_gs_access_rights_db()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_gs_access_rights_granularity()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_gs_access_rights_reserved()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_gs_access_rights_unusable()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ldtr_access_rights()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ldtr_access_rights_type()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ldtr_access_rights_s()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ldtr_access_rights_dpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ldtr_access_rights_present()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ldtr_access_rights_avl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ldtr_access_rights_l()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ldtr_access_rights_db()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ldtr_access_rights_granularity()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ldtr_access_rights_reserved()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ldtr_access_rights_unusable()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_tr_access_rights()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_tr_access_rights_type()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_tr_access_rights_s()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_tr_access_rights_dpl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_tr_access_rights_present()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_tr_access_rights_avl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_tr_access_rights_l()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_tr_access_rights_db()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_tr_access_rights_granularity()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_tr_access_rights_reserved()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_tr_access_rights_unusable()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_interruptibility_state()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_interruptibility_state_blocking_by_sti()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_interruptibility_state_blocking_by_mov_ss()
//{
//    using namespace vmcs::guest_interruptibility_state;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_interruptibility_state_blocking_by_smi()
//{
//    using namespace vmcs::guest_interruptibility_state;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_interruptibility_state_blocking_by_nmi()
//{
//    using namespace vmcs::guest_interruptibility_state;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_interruptibility_state_enclave_interruption()
//{
//    using namespace vmcs::guest_interruptibility_state;
//
...
//
//void
//intrinsics_ut::test_vmcs_guest_interruptibility_state_reserved()
//{
//    using namespace vmcs::guest_interruptibility_state;
//
//    reserved::set(1UL);
...
//
//void
//intrinsics_ut::test_vmcs_guest_activity_state()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_smbase()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_ia32_sysenter_cs()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vmx_preemption_timer_value()
//{
//    g_msrs[msrs::ia32_vmx_true_pinbased_ctls::addr] =
...
//
//void
//intrinsics_ut::test_vmcs_host_ia32_sysenter_cs()
//{
...
//
//void
//intrinsics_ut::test_vmcs_cr0_guest_host_mask()
//{
...
//
//void
//intrinsics_ut::test_vmcs_cr4_guest_host_mask()
//{
...
//
//void
//intrinsics_ut::test_vmcs_cr0_read_shadow()
//{
...
//
//void
//intrinsics_ut::test_vmcs_cr4_read_shadow()
//{
...
//
//void
//intrinsics_ut::test_vmcs_cr3_target_value_0()
//{
...
//
//void
//intrinsics_ut::test_vmcs_cr3_target_value_1()
//{
...
//
//void
//intrinsics_ut::test_vmcs_cr3_target_value_2()
//{
...
//
//void
//intrinsics_ut::test_vmcs_cr3_target_value_3()
//{
...
//
//void
//intrinsics_ut::test_vmcs_pin_based_vm_execution_controls()
//{
...
//
//void
//intrinsics_ut::test_vmcs_pin_based_vm_execution_controls_external_interrupt_exiting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_pin_based_vm_execution_controls_nmi_exiting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_pin_based_vm_execution_controls_virtual_nmis()
//{
...
//
//void
//intrinsics_ut::test_vmcs_pin_based_vm_execution_controls_activate_vmx_preemption_timer()
//{
...
//
//void
//intrinsics_ut::test_vmcs_pin_based_vm_execution_controls_process_posted_interrupts()
//{
...
//
//void
//intrinsics_ut::test_vmcs_primary_processor_based_vm_execution_controls()
//{
...
//
//void
//intrinsics_ut::test_vmcs_primary_processor_based_vm_execution_controls_interrupt_window_exiting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_primary_processor_based_vm_execution_controls_use_tsc_offsetting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_primary_processor_based_vm_execution_controls_hlt_exiting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_primary_processor_based_vm_execution_controls_invlpg_exiting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_primary_processor_based_vm_execution_controls_mwait_exiting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_primary_processor_based_vm_execution_controls_rdpmc_exiting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_primary_processor_based_vm_execution_controls_rdtsc_exiting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_primary_processor_based_vm_execution_controls_cr3_load_exiting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_primary_processor_based_vm_execution_controls_cr3_store_exiting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_primary_processor_based_vm_execution_controls_cr8_load_exiting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_primary_processor_based_vm_execution_controls_cr8_store_exiting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_primary_processor_based_vm_execution_controls_use_tpr_shadow()
//{
...
//
//void
//intrinsics_ut::test_vmcs_primary_processor_based_vm_execution_controls_nmi_window_exiting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_primary_processor_based_vm_execution_controls_mov_dr_exiting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_primary_processor_based_vm_execution_controls_unconditional_io_exiting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_primary_processor_based_vm_execution_controls_use_io_bitmaps()
//{
...
//
//void
//intrinsics_ut::test_vmcs_primary_processor_based_vm_execution_controls_monitor_trap_flag()
//{
...
//
//void
//intrinsics_ut::test_vmcs_primary_processor_based_vm_execution_controls_use_msr_bitmap()
//{
...
//
//void
//intrinsics_ut::test_vmcs_primary_processor_based_vm_execution_controls_monitor_exiting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_primary_processor_based_vm_execution_controls_pause_exiting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_primary_processor_based_vm_execution_controls_activate_secondary_controls()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exception_bitmap()
//{
...
//
//void
//intrinsics_ut::test_vmcs_page_fault_error_code_mask()
//{
...
//
//void
//intrinsics_ut::test_vmcs_page_fault_error_code_match()
//{
...
//
//void
//intrinsics_ut::test_vmcs_cr3_target_count()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_controls()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_controls_save_debug_controls()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_controls_host_address_space_size()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_controls_load_ia32_perf_global_ctrl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_controls_acknowledge_interrupt_on_exit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_controls_save_ia32_pat()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_controls_load_ia32_pat()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_controls_save_ia32_efer()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_controls_load_ia32_efer()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_controls_save_vmx_preemption_timer_value()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_controls_clear_ia32_bndcfgs()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_msr_store_count()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_msr_load_count()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_entry_controls()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_entry_controls_load_debug_controls()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_entry_controls_ia_32e_mode_guest()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_entry_controls_entry_to_smm()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_entry_controls_deactivate_dual_monitor_treatment()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_entry_controls_load_ia32_perf_global_ctrl()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_entry_controls_load_ia32_pat()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_entry_controls_load_ia32_efer()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_entry_controls_load_ia32_bndcfgs()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_entry_msr_load_count()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_entry_interruption_information_field()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_entry_interruption_information_field_vector()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_entry_interruption_information_field_type()
//{
//    using namespace vmcs::vm_entry_interruption_information_field;
//
//    set(0xf701UL);
...
//
//void
//intrinsics_ut::test_vmcs_vm_entry_interruption_information_field_deliver_error_code_bit()
//{
//    using namespace vmcs::vm_entry_interruption_information_field;
//
//    set(0xffff0000UL);
...
//
//void
//intrinsics_ut::test_vmcs_vm_entry_interruption_information_field_reserved()
//{
//    using namespace vmcs::vm_entry_interruption_information_field;
//
//    set(0x701UL);
...
//
//void
//intrinsics_ut::test_vmcs_vm_entry_interruption_information_field_valid_bit()
//{
//    using namespace vmcs::vm_entry_interruption_information_field;
//
//    set(0x0fff0000UL);
...
//
//void
//intrinsics_ut::test_vmcs_vm_entry_exception_error_code()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_entry_instruction_length()
//{
...
//
//void
//intrinsics_ut::test_vmcs_tpr_threshold()
//{
...
//
//void
//intrinsics_ut::test_vmcs_secondary_processor_based_vm_execution_controls()
//{
//    using namespace msrs::ia32_vmx_true_procbased_ctls;
//
...
//
//void
//intrinsics_ut::test_vmcs_secondary_processor_based_vm_execution_controls_virtualize_apic_accesses()
//{
...
//
//void
//intrinsics_ut::test_vmcs_secondary_processor_based_vm_execution_controls_enable_ept()
//{
...
//
//void
//intrinsics_ut::test_vmcs_secondary_processor_based_vm_execution_controls_descriptor_table_exiting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_secondary_processor_based_vm_execution_controls_enable_rdtscp()
//{
...
//
//void
//intrinsics_ut::test_vmcs_secondary_processor_based_vm_execution_controls_virtualize_x2apic_mode()
//{
...
//
//void
//intrinsics_ut::test_vmcs_secondary_processor_based_vm_execution_controls_enable_vpid()
//{
...
//
//void
//intrinsics_ut::test_vmcs_secondary_processor_based_vm_execution_controls_wbinvd_exiting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_secondary_processor_based_vm_execution_controls_unrestricted_guest()
//{
...
//
//void
//intrinsics_ut::test_vmcs_secondary_processor_based_vm_execution_controls_apic_register_virtualization()
//{
...
//
//void
//intrinsics_ut::test_vmcs_secondary_processor_based_vm_execution_controls_virtual_interrupt_delivery()
//{
...
//
//void
//intrinsics_ut::test_vmcs_secondary_processor_based_vm_execution_controls_pause_loop_exiting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_secondary_processor_based_vm_execution_controls_rdrand_exiting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_secondary_processor_based_vm_execution_controls_enable_invpcid()
//{
...
//
//void
//intrinsics_ut::test_vmcs_secondary_processor_based_vm_execution_controls_enable_vm_functions()
//{
...
//
//void
//intrinsics_ut::test_vmcs_secondary_processor_based_vm_execution_controls_vmcs_shadowing()
//{
...
//
//void
//intrinsics_ut::test_vmcs_secondary_processor_based_vm_execution_controls_rdseed_exiting()
//{
...
//
//void
//intrinsics_ut::test_vmcs_secondary_processor_based_vm_execution_controls_enable_pml()
//{
...
//
//void
//intrinsics_ut::test_vmcs_secondary_processor_based_vm_execution_controls_ept_violation_ve()
//{
...
//
//void
//intrinsics_ut::test_vmcs_secondary_processor_based_vm_execution_controls_enable_xsaves_xrstors()
//{
...
//
//void
//intrinsics_ut::test_vmcs_ple_gap()
//{
//    using namespace msrs::ia32_vmx_true_procbased_ctls;
//
//    g_msrs[addr] = activate_secondary_controls::mask << 32;
...
//
//void
//intrinsics_ut::test_vmcs_ple_window()
//{
//    using namespace msrs::ia32_vmx_true_procbased_ctls;
//
//    g_msrs[addr] = activate_secondary_controls::mask << 32;
...
//
//void
//intrinsics_ut::test_vmcs_vm_instruction_error()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_reason()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_reason_basic_exit_reason()
//{
//    using namespace vmcs::exit_reason;
//
...
//
//void
//intrinsics_ut::test_vmcs_exit_reason_reserved()
//{
//    using namespace vmcs::exit_reason;
//
...
//
//void
//intrinsics_ut::test_vmcs_exit_reason_vm_exit_incident_to_enclave_mode()
//{
//    using namespace vmcs::exit_reason;
//
...
//
//void
//intrinsics_ut::test_vmcs_exit_reason_pending_mtf_vm_exit()
//{
//    using namespace vmcs::exit_reason;
//
//    g_vmcs_fields[addr] = 0UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_reason_vm_exit_from_vmx_root_operation()
//{
//    using namespace vmcs::exit_reason;
//
//    g_vmcs_fields[addr] = 0UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_reason_vm_entry_failure()
//{
//    using namespace vmcs::exit_reason;
//
//    g_vmcs_fields[addr] = 0UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_interruption_information()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_interruption_information_vector()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_interruption_information_interruption_type()
//{
//    g_vmcs_fields[vmcs::vm_exit_interruption_information::addr] = 0xFFFUL;
//
//    this->expect_true(vmcs::vm_exit_interruption_information::interruption_type::get() == 7UL);
//    this->expect_true(vmcs::vm_exit_interruption_information::interruption_type::get_if_exists() ==
//                      7UL);
//}
//
//void
//intrinsics_ut::test_vmcs_vm_exit_interruption_information_error_code_valid()
//{
//    g_vmcs_fields[vmcs::vm_exit_interruption_information::addr] = 0xFFFUL;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_interruption_information_nmi_blocking_due_to_iret()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_interruption_information_reserved()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_interruption_information_valid_bit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_interruption_error_code()
//{
...
//
//void
//intrinsics_ut::test_vmcs_idt_vectoring_information()
//{
...
//
//void
//intrinsics_ut::test_vmcs_idt_vectoring_information_vector()
//{
...
//
//void
//intrinsics_ut::test_vmcs_idt_vectoring_information_interruption_type()
//{
//    g_vmcs_fields[vmcs::idt_vectoring_information::addr] = 0xFFFUL;
//
...
//
//void
//intrinsics_ut::test_vmcs_idt_vectoring_information_error_code_valid()
//{
//    g_vmcs_fields[vmcs::idt_vectoring_information::addr] = 0xFFFUL;
//
...
//
//void
//intrinsics_ut::test_vmcs_idt_vectoring_information_reserved()
//{
...
//
//void
//intrinsics_ut::test_vmcs_idt_vectoring_information_valid_bit()
//{
...
//
//void
//intrinsics_ut::test_vmcs_idt_vectoring_error_code()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_length()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_ins()
//{
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_ins_address_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_outs()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
//    g_vmcs_fields[addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_outs_address_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_outs_segment_register()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invept()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
//    g_vmcs_fields[addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invept_scaling()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invept_address_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invept_segment_register()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invept_index_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invept_index_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invept_base_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invept_base_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invept_reg2()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invpcid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
//    g_vmcs_fields[addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invpcid_scaling()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invpcid_address_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invpcid_segment_register()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invpcid_index_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invpcid_index_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//    this->expect_true(invpcid::index_reg_invalid::get_if_exists() ==
//                      invpcid::index_reg_invalid::invalid);
//}
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invpcid_base_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invpcid_base_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invpcid_reg2()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invvpid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
//    g_vmcs_fields[addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invvpid_scaling()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invvpid_address_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invvpid_segment_register()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invvpid_index_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invvpid_index_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//    this->expect_true(invvpid::index_reg_invalid::get_if_exists() ==
//                      invvpid::index_reg_invalid::invalid);
//}
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invvpid_base_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invvpid_base_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_invvpid_reg2()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lidt()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
//    g_vmcs_fields[addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lidt_scaling()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lidt_address_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lidt_operand_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lidt_segment_register()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lidt_index_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lidt_index_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lidt_base_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lidt_base_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lidt_instruction_identity()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lgdt()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
//    g_vmcs_fields[addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lgdt_scaling()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lgdt_address_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lgdt_operand_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lgdt_segment_register()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lgdt_index_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lgdt_index_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lgdt_base_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lgdt_base_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lgdt_instruction_identity()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sidt()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
//    g_vmcs_fields[addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sidt_scaling()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sidt_address_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sidt_operand_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sidt_segment_register()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sidt_index_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sidt_index_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sidt_base_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sidt_base_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sidt_instruction_identity()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sgdt()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
//    g_vmcs_fields[addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sgdt_scaling()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sgdt_address_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sgdt_operand_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sgdt_segment_register()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sgdt_index_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sgdt_index_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sgdt_base_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sgdt_base_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sgdt_instruction_identity()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lldt()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
//    g_vmcs_fields[addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lldt_scaling()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lldt_reg1()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lldt_address_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lldt_mem_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lldt_segment_register()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lldt_index_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lldt_index_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lldt_base_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lldt_base_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_lldt_instruction_identity()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_ltr()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
//    g_vmcs_fields[addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_ltr_scaling()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_ltr_reg1()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_ltr_address_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_ltr_mem_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_ltr_segment_register()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_ltr_index_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_ltr_index_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_ltr_base_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_ltr_base_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_ltr_instruction_identity()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sldt()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
//    g_vmcs_fields[addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sldt_scaling()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sldt_reg1()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sldt_address_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sldt_mem_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sldt_segment_register()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sldt_index_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sldt_index_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sldt_base_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sldt_base_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_sldt_instruction_identity()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_str()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
//    g_vmcs_fields[addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_str_scaling()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_str_reg1()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_str_address_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_str_mem_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_str_segment_register()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_str_index_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_str_index_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_str_base_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_str_base_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_str_instruction_identity()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_rdrand()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
//    g_vmcs_fields[addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_rdrand_destination_register()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//    this->expect_true(rdrand::destination_register::get_if_exists() ==
//                      rdrand::destination_register::r14);
//}
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_rdrand_operand_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_rdseed()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
//    g_vmcs_fields[addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_rdseed_destination_register()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//    this->expect_true(rdseed::destination_register::get_if_exists() ==
//                      rdseed::destination_register::r14);
//}
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_rdseed_operand_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmclear()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
//    g_vmcs_fields[addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmclear_scaling()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmclear_address_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmclear_segment_register()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmclear_index_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmclear_index_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//    this->expect_true(vmclear::index_reg_invalid::get_if_exists() ==
//                      vmclear::index_reg_invalid::invalid);
//}
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmclear_base_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmclear_base_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmptrld()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
//    g_vmcs_fields[addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmptrld_scaling()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmptrld_address_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmptrld_segment_register()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmptrld_index_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmptrld_index_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//    this->expect_true(vmptrld::index_reg_invalid::get_if_exists() ==
//                      vmptrld::index_reg_invalid::invalid);
//}
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmptrld_base_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmptrld_base_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmptrst()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
//    g_vmcs_fields[addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmptrst_scaling()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmptrst_address_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmptrst_segment_register()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmptrst_index_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmptrst_index_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//    this->expect_true(vmptrst::index_reg_invalid::get_if_exists() ==
//                      vmptrst::index_reg_invalid::invalid);
//}
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmptrst_base_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmptrst_base_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmxon()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
//    g_vmcs_fields[addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmxon_scaling()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmxon_address_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmxon_segment_register()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmxon_index_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmxon_index_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmxon_base_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmxon_base_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_xrstors()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
//    g_vmcs_fields[addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_xrstors_scaling()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_xrstors_address_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_xrstors_segment_register()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_xrstors_index_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_xrstors_index_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//    this->expect_true(xrstors::index_reg_invalid::get_if_exists() ==
//                      xrstors::index_reg_invalid::invalid);
//}
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_xrstors_base_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_xrstors_base_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_xsaves()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
//    g_vmcs_fields[addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_xsaves_scaling()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_xsaves_address_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_xsaves_segment_register()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_xsaves_index_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_xsaves_index_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_xsaves_base_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_xsaves_base_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmread()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
//    g_vmcs_fields[addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmread_scaling()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmread_reg1()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmread_address_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmread_mem_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmread_segment_register()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmread_index_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmread_index_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmread_base_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmread_base_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmread_reg2()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmwrite()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
//    g_vmcs_fields[addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmwrite_scaling()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmwrite_reg1()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmwrite_address_size()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmwrite_mem_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmwrite_segment_register()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmwrite_index_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmwrite_index_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//    this->expect_true(vmwrite::index_reg_invalid::get_if_exists() ==
//                      vmwrite::index_reg_invalid::invalid);
//}
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmwrite_base_reg()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmwrite_base_reg_invalid()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_vm_exit_instruction_information_vmwrite_reg2()
//{
//    using namespace vmcs::vm_exit_instruction_information;
//
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_debug_exception()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_debug_exception_b0()
//{
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 1UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_debug_exception_b1()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_debug_exception_b2()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_debug_exception_b3()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_debug_exception_reserved()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_debug_exception_bd()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_debug_exception_bs()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_page_fault_exception()
//{
//    this->expect_true(vmcs::exit_qualification::page_fault_exception::get_name() ==
...
//    this->expect_true(vmcs::exit_qualification::page_fault_exception::address_if_exists() ==
//                      0x10000000UL);
//}
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_sipi()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_sipi_vector()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_task_switch()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_task_switch_tss_selector()
//{
...
//    this->expect_true(vmcs::exit_qualification::task_switch::tss_selector::get(
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_task_switch_reserved()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_task_switch_source_of_task_switch_init()
//{
//    using namespace vmcs::exit_qualification::task_switch;
//
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x0UL;
//    this->expect_true(source_of_task_switch_init::get() ==
//                      source_of_task_switch_init::call_instruction);
//    this->expect_true(source_of_task_switch_init::get(0x0UL) ==
//                      source_of_task_switch_init::call_instruction);
//
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x40000000UL;
//    this->expect_true(source_of_task_switch_init::get() ==
//                      source_of_task_switch_init::iret_instruction);
//    this->expect_true(source_of_task_switch_init::get(0x40000000UL) ==
//                      source_of_task_switch_init::iret_instruction);
//
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x80000000UL;
//    this->expect_true(source_of_task_switch_init::get_if_exists() ==
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_invept()
//{
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x1UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_invpcid()
//{
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x1UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_invvpid()
//{
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x1UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_lgdt()
//{
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x1UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_lidt()
//{
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x1UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_lldt()
//{
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x1UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_ltr()
//{
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x1UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_sgdt()
//{
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x1UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_sidt()
//{
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x1UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_sldt()
//{
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x1UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_str()
//{
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x1UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_vmclear()
//{
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x1UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_vmptrld()
//{
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x1UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_vmread()
//{
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x1UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_vmwrite()
//{
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x1UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_vmxon()
//{
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x1UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_xrstors()
//{
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x1UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_xsaves()
//{
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x1UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_control_register_access()
//{
//    this->expect_true(vmcs::exit_qualification::control_register_access::get_name() ==
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_control_register_access_control_register_number()
//{
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x42UL;
//    this->expect_true(vmcs::exit_qualification::control_register_access::control_register_number::get()
//                      == 0x2UL);
//    this->expect_true(vmcs::exit_qualification::control_register_access::control_register_number::get(
//                          0x42UL) == 0x2UL);
//
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_control_register_access_access_type()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_control_register_access_lmsw_operand_type()
//{
//    using namespace vmcs::exit_qualification::control_register_access;
//
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x00UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_control_register_access_reserved()
//{
...
//    this->expect_true(vmcs::exit_qualification::control_register_access::reserved::get(
//                          0x3080UL) == 0x3080UL);
//
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x0UL;
//    this->expect_true(vmcs::exit_qualification::control_register_access::reserved::get_if_exists() ==
//                      0x0UL);
//}
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_control_register_access_general_purpose_register()
//{
//    using namespace vmcs::exit_qualification::control_register_access;
//
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_control_register_access_source_data()
//{
//    using namespace vmcs::exit_qualification::control_register_access;
//
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_mov_dr()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_mov_dr_debug_register_number()
//{
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x42UL;
...
//
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x0UL;
//    this->expect_true(vmcs::exit_qualification::mov_dr::debug_register_number::get_if_exists() ==
//                      0x0UL);
//}
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_mov_dr_reserved()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_mov_dr_direction_of_access()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_mov_dr_general_purpose_register()
//{
//    using namespace vmcs::exit_qualification::mov_dr;
//
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_io_instruction()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_io_instruction_size_of_access()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_io_instruction_direction_of_access()
//{
//    using namespace vmcs::exit_qualification::io_instruction;
//
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x0UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_io_instruction_string_instruction()
//{
//    using namespace vmcs::exit_qualification::io_instruction;
//
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x0UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_io_instruction_rep_prefixed()
//{
//    using namespace vmcs::exit_qualification::io_instruction;
//
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x0UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_io_instruction_operand_encoding()
//{
//    using namespace vmcs::exit_qualification::io_instruction;
//
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x0UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_io_instruction_reserved()
//{
//    using namespace vmcs::exit_qualification::io_instruction;
//
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x0UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_io_instruction_port_number()
//{
//    using namespace vmcs::exit_qualification::io_instruction;
//
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x0UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_mwait()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_linear_apic_access()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_linear_apic_access_offset()
//{
//    using namespace vmcs::exit_qualification::linear_apic_access;
//
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x1UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_linear_apic_access_access_type()
//{
//    using namespace vmcs::exit_qualification::linear_apic_access;
//
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x0UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_linear_apic_access_reserved()
//{
//    using namespace vmcs::exit_qualification::linear_apic_access;
//
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x0UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_guest_physical_apic_access()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_guest_physical_apic_access_access_type()
//{
//    using namespace vmcs::exit_qualification::guest_physical_apic_access;
//
...
//    this->expect_true(access_type::get(0xFUL << access_type::from) ==
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_guest_physical_apic_access_reserved()
//{
//    using namespace vmcs::exit_qualification::guest_physical_apic_access;
//
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x0UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_ept_violation()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_ept_violation_data_read()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_ept_violation_data_write()
//{
//    using namespace vmcs::exit_qualification::ept_violation;
//
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_ept_violation_instruction_fetch()
//{
//    using namespace vmcs::exit_qualification::ept_violation;
//
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_ept_violation_readable()
//{
//    using namespace vmcs::exit_qualification::ept_violation;
//
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_ept_violation_writeable()
//{
//    using namespace vmcs::exit_qualification::ept_violation;
//
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_ept_violation_executable()
//{
//    using namespace vmcs::exit_qualification::ept_violation;
//
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_ept_violation_reserved()
//{
//    using namespace vmcs::exit_qualification::ept_violation;
//
//    g_vmcs_fields[vmcs::exit_qualification::addr] = 0x40UL;
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_ept_violation_valid_guest_linear_address()
//{
//    using namespace vmcs::exit_qualification::ept_violation;
//
...
//    this->expect_true(valid_guest_linear_address::is_enabled(0x1UL <<
...
//    this->expect_true(valid_guest_linear_address::is_disabled(0x0UL <<
//                      valid_guest_linear_address::from));
//    this->expect_true(valid_guest_linear_address::is_disabled_if_exists());
//}
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_ept_violation_nmi_unblocking_due_to_iret()
//{
//    using namespace vmcs::exit_qualification::ept_violation;
//
...
//    this->expect_true(nmi_unblocking_due_to_iret::is_enabled(0x1UL <<
...
//    this->expect_true(nmi_unblocking_due_to_iret::is_disabled(0x0UL <<
//                      nmi_unblocking_due_to_iret::from));
//    this->expect_true(nmi_unblocking_due_to_iret::is_disabled_if_exists());
//}
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_eoi_virtualization()
//{
//    this->expect_true(vmcs::exit_qualification::eoi_virtualization::get_name() ==
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_eoi_virtualization_vector()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_apic_write()
//{
...
//
//void
//intrinsics_ut::test_vmcs_exit_qualification_apic_write_offset()
//{
...
//
//void
//intrinsics_ut::test_vmcs_io_rcx()
//{
...
//
//void
//intrinsics_ut::test_vmcs_io_rsi()
//{
...
//
//void
//intrinsics_ut::test_vmcs_io_rdi()
//{
...
//
//void
//intrinsics_ut::test_vmcs_io_rip()
//{
...
//
//void
//intrinsics_ut::test_vmcs_guest_linear_address()
//{
