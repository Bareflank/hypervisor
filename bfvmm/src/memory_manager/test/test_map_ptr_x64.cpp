...
bfn::unique_map_ptr_x64<int>::attr_type read_write = bfn::unique_map_ptr_x64<int>::map_read_write;
...
memory_manager_ut::test_unique_map_ptr_x64_phys_constructor_invalid_args()
{
    ...
    this->expect_exception([&] { bfn::unique_map_ptr_x64<int>(valid_virt, valid_phys, bfn::unique_map_ptr_x64<int>::map_none); }, ""_ut_ffe);
}
...
memory_manager_ut::test_unique_map_ptr_x64_phys_range_constructor_invalid_args()
{
    ...
    this->expect_exception([&] { bfn::unique_map_ptr_x64<int>(valid_virt, list, bfn::unique_map_ptr_x64<int>::map_none); }, ""_ut_ffe);
...
{
    this->expect_exception([&] { bfn::unique_map_ptr_x64<int>(invalid_virt, valid_virt, valid_phys, x64::page_size, read_write); }, ""_ut_ffe);
    this->expect_exception([&] { bfn::unique_map_ptr_x64<int>(valid_virt + 0x10U, valid_virt, valid_phys, x64::page_size, read_write); }, ""_ut_ffe);
    this->expect_exception([&] { bfn::unique_map_ptr_x64<int>(valid_virt, invalid_virt, valid_phys, x64::page_size, read_write); }, ""_ut_ffe);
    this->expect_exception([&] { bfn::unique_map_ptr_x64<int>(valid_virt, valid_virt, invalid_phys, x64::page_size, read_write); }, ""_ut_ffe);
    this->expect_exception([&] { bfn::unique_map_ptr_x64<int>(valid_virt, valid_virt, valid_phys + 0x10U, x64::page_size, read_write); }, ""_ut_ffe);
    this->expect_exception([&] { bfn::unique_map_ptr_x64<int>(valid_virt, valid_virt, valid_phys, 0, read_write); }, ""_ut_ffe);
    this->expect_exception([&] { bfn::unique_map_ptr_x64<int>(valid_virt, valid_virt, valid_phys, x64::page_size, bfn::unique_map_ptr_x64<int>::map_none); }, ""_ut_ffe);
}
...
memory_manager_ut::test_unique_map_ptr_x64_virt_cr3_constructor_mm_map_fails()
{
    ...
    RUN_UNITTEST_WITH_MOCKS(mocks, [&]
    {
        this->expect_exception([&]{ bfn::unique_map_ptr_x64<int>(valid_virt, valid_virt, valid_phys, x64::page_size, read_write); }, ""_ut_ree);
    });
}
...
memory_manager_ut::test_unique_map_ptr_x64_virt_cr3_constructor_success()
{
    ...
    RUN_UNITTEST_WITH_MOCKS(mocks, [&]
    {
        auto &&map = bfn::unique_map_ptr_x64<int>(valid_virt, valid_virt, valid_phys, x64::page_size * 2UL, read_write);
...
memory_manager_ut::test_unique_map_ptr_x64_virt_cr3_constructor_success_large_page()
{
    ...
    RUN_UNITTEST_WITH_MOCKS(mocks, [&]
    {
        auto &&map = bfn::unique_map_ptr_x64<int>(valid_virt, valid_virt + phys_offset, valid_phys, x64::page_size * 2UL, read_write);
...
memory_manager_ut::test_unique_map_ptr_x64_virt_cr3_constructor_not_present()
{
    ...
    RUN_UNITTEST_WITH_MOCKS(mocks, [&]
    {
        this->expect_exception([&]{ bfn::unique_map_ptr_x64<int>(valid_virt, valid_map, valid_phys, x64::page_size, read_write); }, ""_ut_ffe);
    });
}
...
memory_manager_ut::test_unique_map_ptr_x64_reference_operators()
{
    ...
    RUN_UNITTEST_WITH_MOCKS(mocks, [&]
    {
        auto &&map = bfn::unique_map_ptr_x64<foo_t>(upper, valid_phys + lower, bfn::unique_map_ptr_x64<foo_t>::map_read_write);
        auto &&foo2 = *map;
...
memory_manager_ut::test_unique_map_ptr_x64_make_failure()
{
    ...
    RUN_UNITTEST_WITH_MOCKS(mocks, [&]
    {
        ...
        g_freed.clear();
        this->expect_exception([&]{ bfn::make_unique_map_x64<int>(0UL, 0UL, 0UL); }, ""_ut_ffe);
        this->expect_true(g_freed[dummy_pt.get()]);
    });
}
