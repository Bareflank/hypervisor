...
if (BUILD_EFI AND NOT BUILD_VMM)
    invalid_config("BUILD_VMM must be enabled to build EFI-bootable vmm (BUILD_EFI)")
endif()
...
if(ENABLE_ASAN)
    ...
    if(NOT BUILD_TEST)
        invalid_config("BUILD_TEST must be enabled if ENABLE_ASAN is enabled")
    endif()
endif()
...
if(ENABLE_USAN)
    ...
    if(NOT BUILD_TEST)
        invalid_config("BUILD_TEST must be enabled if ENABLE_USAN is enabled")
    endif()
endif()

if(ENABLE_CODECOV)
    if(NOT BUILD_TEST)
        invalid_config("BUILD_TEST must be enabled if ENABLE_CODECOV is enabled")
    endif()
endif()

if(ENABLE_TIDY)
    if(NOT BUILD_TEST)
        invalid_config("BUILD_TEST must be enabled if ENABLE_TIDY is enabled")
    endif()
endif()
...
if(CMAKE_HOST_SYSTEM_NAME STREQUAL "Windows")
    if(BUILD_VMM)
        invalid_config("BUILD_VMM is not supported on Windows")
    endif()
    if(ENABLE_ASAN)
