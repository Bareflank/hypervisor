...
public:
    ...
    virtual void enable_cr4_write_vmexit() noexcept = 0;

    /// @brief Disable vmexits for all writes to control register cr4
    virtual void disable_cr4_write_vmexit() noexcept = 0;
    ...
    virtual void set_cr4_write_vmexit_handler(x64_vcpu_delegate func) noexcept = 0;
    ...
    virtual uint64_t get_cr4_write_vmexit_value() noexcept = 0;
    ...
    virtual void execute_cr4_write() noexcept = 0;
    ...
    virtual void emulate_cr4_write(uint64_t cr4_value) noexcept = 0;
