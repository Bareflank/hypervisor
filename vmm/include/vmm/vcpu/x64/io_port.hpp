...
public:
    ...
    virtual void io_port_vmexit_handler_set(x64_vcpu_delegate func) noexcept = 0;
    ...
    virtual void io_port_out_execute() noexcept = 0;
    ...
    virtual void io_port_out_emulate(uint64_t value) noexcept = 0;
    ...
    virtual void io_port_in_execute() noexcept = 0;
    ...
    virtual void io_port_in_emulate(uint64_t value) noexcept = 0;
