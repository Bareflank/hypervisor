...
public:
    ...
    virtual void enable_rdmsr_vmexit(uint32_t msr_address) noexcept = 0;
    ...
    virtual void enable_rdmsr_vmexit_range(uint32_t begin, uint32_t end) noexcept = 0;
    ...
    virtual void disable_rdmsr_vmexit(uint32_t msr_address) noexcept = 0;
    ...
    virtual void disable_rdmsr_vmexit_range(uint32_t begin, uint32_t end) noexcept = 0;
    ...
    virtual void set_rdmsr_vmexit_handler(x64_vcpu_delegate func) noexcept = 0;
    ...
    ///     vmexit to occur
    virtual uint32_t get_rdmsr_vmexit_address() noexcept = 0;
    ...
    virtual void execute_rdmsr() noexcept = 0;
    ...
    ///     instruction
    virtual void emulate_rdmsr(uint64_t value) noexcept = 0;
