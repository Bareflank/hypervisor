...
public:
    ...
    virtual void wrmsr_vmexit_enable(uint32_t msr_address) noexcept = 0;
    ...
    virtual void wrmsr_vmexit_range_enable(uint32_t begin, uint32_t end) noexcept = 0;
    ...
    virtual void wrmsr_vmexit_disable(uint32_t msr_address) noexcept = 0;
    ...
    virtual void wrmsr_vmexit_range_disable(uint32_t begin, uint32_t end) noexcept = 0;
    ...
    virtual void wrmsr_execute() noexcept = 0;
    ...
    virtual void wrmsr_emulate(uint64_t value) noexcept = 0;
