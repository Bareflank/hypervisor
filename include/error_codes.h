...
ec_to_str(int64_t value)
{
    switch (value)
    {
        STRINGIY_AND_RETURN(SUCCESS);
        STRINGIY_AND_RETURN(ENTRY_ERROR_STACK_OVERFLOW);
        STRINGIY_AND_RETURN(ENTRY_ERROR_VMM_INIT_FAILED);
        STRINGIY_AND_RETURN(ENTRY_ERROR_VMM_START_FAILED);
        STRINGIY_AND_RETURN(ENTRY_ERROR_VMM_STOP_FAILED);
        STRINGIY_AND_RETURN(ENTRY_ERROR_UNKNOWN);
        STRINGIY_AND_RETURN(CRT_FAILURE);
        STRINGIY_AND_RETURN(REGISTER_EH_FRAME_FAILURE);
        STRINGIY_AND_RETURN(GET_DRR_FAILURE);
        STRINGIY_AND_RETURN(MEMORY_MANAGER_FAILURE);
        STRINGIY_AND_RETURN(BFELF_ERROR_INVALID_ARG);
        STRINGIY_AND_RETURN(BFELF_ERROR_INVALID_FILE);
        STRINGIY_AND_RETURN(BFELF_ERROR_INVALID_INDEX);
        STRINGIY_AND_RETURN(BFELF_ERROR_INVALID_STRING);
        STRINGIY_AND_RETURN(BFELF_ERROR_INVALID_SIGNATURE);
        STRINGIY_AND_RETURN(BFELF_ERROR_UNSUPPORTED_FILE);
        STRINGIY_AND_RETURN(BFELF_ERROR_INVALID_SEGMENT);
        STRINGIY_AND_RETURN(BFELF_ERROR_INVALID_SECTION);
        STRINGIY_AND_RETURN(BFELF_ERROR_LOADER_FULL);
        STRINGIY_AND_RETURN(BFELF_ERROR_NO_SUCH_SYMBOL);
        STRINGIY_AND_RETURN(BFELF_ERROR_MISMATCH);
        STRINGIY_AND_RETURN(BFELF_ERROR_UNSUPPORTED_RELA);
        STRINGIY_AND_RETURN(BFELF_ERROR_OUT_OF_ORDER);
        STRINGIY_AND_RETURN(BF_ERROR_INVALID_ARG);
        STRINGIY_AND_RETURN(BF_ERROR_INVALID_INDEX);
        STRINGIY_AND_RETURN(BF_ERROR_NO_MODULES_ADDED);
        STRINGIY_AND_RETURN(BF_ERROR_MAX_MODULES_REACHED);
        STRINGIY_AND_RETURN(BF_ERROR_VMM_INVALID_STATE);
        STRINGIY_AND_RETURN(BF_ERROR_FAILED_TO_ADD_FILE);
        STRINGIY_AND_RETURN(BF_ERROR_FAILED_TO_DUMP_DR);
        STRINGIY_AND_RETURN(BF_ERROR_OUT_OF_MEMORY);
        STRINGIY_AND_RETURN(BF_ERROR_VMM_CORRUPTED);
        STRINGIY_AND_RETURN(BF_ERROR_UNKNOWN);
        STRINGIY_AND_RETURN(BF_BAD_ALLOC);
        STRINGIY_AND_RETURN(BF_IOCTL_FAILURE);
    }
