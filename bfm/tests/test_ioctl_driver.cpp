...
setup_command_line_parser(MockRepository &mocks, clpc type)
{
    ...
    mocks.OnCall(clp, command_line_parser::ifile).Return(std::string{});
    mocks.OnCall(clp, command_line_parser::ofile).Return(std::string{});
...
TEST_CASE("test ioctl driver process vmcall vmm unloaded")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall vmm loaded")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall vmm corrupt")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall vmm unknown")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall unknown vmcall")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall versions ioctl failed")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall versions ioctl return failed")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall versions protocol version")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall versions bareflank version")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall versions user version")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall versions unknown")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall registers ioctl failed")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall registers ioctl return failed")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall registers success")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall unittest ioctl failed")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall unittest ioctl return failed")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall unittest success")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall event ioctl failed")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall event ioctl return failed")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall event success")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall data string unformatted unknown data type")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall data string unformatted ioctl failed")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall data string unformatted ioctl return failed")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall data string unformatted out of range")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall data string unformatted success no return")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall data string unformatted success unformatted")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall data string json ioctl failed")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall data string json ioctl return failed")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall data string json out of range")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall data string json success no return")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall data string json parse failure")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall data string json success json")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall data binary unformatted ifile failed")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall data binary unformatted ioctl failed")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall data binary unformatted ioctl return failed")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall data binary unformatted out of range")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall data binary unformatted success no return")
{
    MockRepository mocks;
...
TEST_CASE("test ioctl driver process vmcall data binary unformatted success unformatted")
{
    MockRepository mocks;
