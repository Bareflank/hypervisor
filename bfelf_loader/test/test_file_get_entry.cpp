...
void
bfelf_loader_ut::test_bfelf_file_get_entry_invalid_ef()
{
    void *addr = nullptr;
...
void
bfelf_loader_ut::test_bfelf_file_get_entry_invalid_addr()
{
    auto ret = 0LL;
...
void
bfelf_loader_ut::test_bfelf_file_get_entry_success()
{
    auto ret = 0LL;
    void *addr = nullptr;
