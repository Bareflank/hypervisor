...
private:
    ...
    void test_bfelf_loader_relocate_no_symbol();
    ...
    void test_private_relocate_invalid_relocation_dyn();
    void test_private_relocate_invalid_relocation_plt();
    void test_private_process_dynamic_section();
