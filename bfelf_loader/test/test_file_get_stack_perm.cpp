...
void
bfelf_loader_ut::test_bfelf_file_get_stack_perm_invalid_ef()
{
    bfelf64_xword perm = 0;

    auto ret = bfelf_file_get_stack_perm(nullptr, &perm);
    this->expect_true(ret == BFELF_ERROR_INVALID_ARG);
}

void
bfelf_loader_ut::test_bfelf_file_get_stack_perm_invalid_addr()
{
    auto ret = 0LL;
...
void
bfelf_loader_ut::test_bfelf_file_get_stack_perm_success()
{
    auto ret = 0LL;
    bfelf64_xword perm = 0;
