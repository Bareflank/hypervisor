...
class Process(object):
    ...
    def __init__(self, proc, outfile, source_file):
        self.proc = proc
    ...
    def start(cls, invocation):
        ...
        return cls(process, outfile, invocation.source_file)


class Invocation(object):
    """ Holds arguments of an IWYU invocation. """
    def __init__(self, command, cwd, source_file):
    ...
    def from_compile_command(cls, entry, extra_args):
        ...
        return cls(command, entry['directory'], source_file)
...
def execute(invocations, verbose, formatter, jobs):
    ...
    if jobs == 1:
        for invocation in invocations:
            ...
            print(formatter(proc.get_output()), end = "")
            if proc.returncode != 2:
                print("\n\033[91mfailure: \033[0m" + proc.source_file)
                print(formatter(proc.get_output()), end = "")
                exit_code = 1
            else:
                print("\033[92msuccess: \033[0m" + proc.source_file)
        return exit_code
